...
function App() {
  ...
  return (
    <div style={{ background: "#434343" }} className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-4 text-white">
      <h1 className="text-white text-center my-3" style={{ fontSize: "20px" }}>Password Genertor</h1>
